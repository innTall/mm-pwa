...
import { useSpotBitgetResStore } from "@/stores/spotBitgetRes.js";
import { storeToRefs } from "pinia";

const { isBlockComplete, addBlock, removeBlock } = useSpotBitgetResStore();
const { blocks, blockMetrics, totalProfit } = storeToRefs(useSpotBitgetResStore());
...
<template>
	<div class="container min-h-screen mb-10 px-2 py-1 text-sm">
		<div class="flex justify-between border px-2 py-1">
			<div class="">BITGET Spot Order</div>
