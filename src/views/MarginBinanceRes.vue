...
import { useMarginBinanceResStore } from "@/stores/marginBinanceRes.js";
const { orderBlocks } = storeToRefs(useMarginBinanceResStore());
const { T_P, S_L, addNewBlock, removeBlock } = useMarginBinanceResStore();
